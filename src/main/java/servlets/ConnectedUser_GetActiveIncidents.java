...
public class ConnectedUser_GetActiveIncidents extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConnectedUser_GetActiveIncidents</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConnectedUser_GetActiveIncidents at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Incident> ActiveIncidents = IncidentsDAO.getActIncForMessages();
    ...
    public String getServletInfo() {
        return "This servlet returns the active incidents' info to the user.";
    }
}
