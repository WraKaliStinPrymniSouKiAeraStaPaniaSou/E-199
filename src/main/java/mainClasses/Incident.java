...
public class Incident {
    ...
    public void setIncident_type(String incident_type) { this.incident_type = incident_type; }
    ...
    public void setExistedStartDatetime(String start_datetime) {
    ...
    public int getFiremen() { return firemen; }
    public void setFiremen(int firemen) { this.firemen = firemen; }
}
