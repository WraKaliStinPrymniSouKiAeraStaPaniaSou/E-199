async function checkLogin() {
    ...
    try {
        ...
        const response = await fetch(`/E-199/LoginUser?username=${form_data.username}&password=${form_data.password}`, {
           method: 'GET',
        ...
        if (result.success) {
            window.location.href = "/E-199/html/ConnectedUser_InitialPage.html";
        } else {
